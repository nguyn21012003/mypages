  ...
  return (
    <div className="flex h-screen w-full bg-transparent">
      <div className="mx-4 mb-10 flex flex-col space-y-10 text-pretty lg:ml-[14rem]">
        ...
        >
          You can acces this link via google form to write feedback for us and
          fell free to ask us questions
        </a>
        <p>
        ...
        <motion.div className="space-y-10 md:flex md:space-x-10 md:space-y-0">
          <motion.div
            className="group flex w-[14rem] items-center justify-center rounded-xl bg-[#18181b] p-2 dark:bg-white"
          ...
          >
            <a
              ...
              className="flex items-center justify-center font-semibold text-white dark:text-[#0b1215]"
            >
              <FcFeedback className="mr-1 inline-block text-white dark:text-[#0b1215]" />
              Contact us
            </a>
          </motion.div>
        </motion.div>
