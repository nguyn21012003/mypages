...
export const App: React.FC = () => {
  ...
  return (
    <div className={`${darkMode && "dark"}`}>
      <div className="static h-full w-full bg-[#f1faff] dark:bg-[#101720]">
        ...
        <button
          ...
          className="fixed bottom-0 right-0 z-50 mb-2 me-3 rounded-full border border-black p-2 text-black dark:border-white dark:text-white"
        >
